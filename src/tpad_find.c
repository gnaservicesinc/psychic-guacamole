...
void replace_dialog(){
    ...
    gtk_box_append(GTK_BOX(mainbox), findbox);
    gtk_box_append(GTK_BOX(mainbox), replacebox);
    gtk_box_append(GTK_BOX(mainbox), boxbutton);
//GtkClipboard *S_Clip;
    gtk_box_append(GTK_BOX(findbox), GTK_WIDGET(gtk_label_new(_SEARCH_FOR)));
	...
	gtk_box_append(GTK_BOX(findbox), GTK_WIDGET(findentry));
	gtk_box_append(GTK_BOX(findbox), GTK_WIDGET(vseparator[0]));

    gtk_box_append(GTK_BOX(replacebox), GTK_WIDGET(gtk_label_new(_REPLACE_WITH)));
    ...
    gtk_box_append(GTK_BOX(replacebox), GTK_WIDGET(replaceentry));
	gtk_box_append(GTK_BOX(replacebox), GTK_WIDGET(vseparator[1]));

    buttonfind=gtk_button_new_with_label(_FIND);
    gtk_box_append(GTK_BOX(boxbutton), GTK_WIDGET(buttonfind));

    buttonreplace=gtk_button_new_with_label(_REPLACE);
    gtk_box_append(GTK_BOX(boxbutton), GTK_WIDGET(buttonreplace));

	gtk_box_append(GTK_BOX(boxbutton), GTK_WIDGET(vseparator[2]));

    buttonfindreplace=gtk_button_new_with_label(_FIND_AND_REPLACE);
    gtk_box_append(GTK_BOX(boxbutton), GTK_WIDGET(buttonfindreplace));
	...
	gtk_box_append(GTK_BOX(boxbutton), GTK_WIDGET(convtbutton));
	doCOVT=TRUE;
